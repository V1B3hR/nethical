...
class ValidationConfig:
    ...
    def _default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "ethics_benchmark": {
                "enabled": True,
                "thresholds": {"precision": 0.92, "recall": 0.88, "f1_score": 0.90},
            },
            "performance": {
                "enabled": True,
                "thresholds": {
            ...
            "data_integrity": {
                "enabled": True,
                "drift": {"psi_threshold": 0.2, "ks_test_alpha": 0.05},
            },
            "explainability": {
                "enabled": True,
                "thresholds": {"min_stability": 0.8, "min_coverage": 0.95},
            },
        }
    ...
    def get_threshold(
        self, suite_name: str, metric: str, default: float = 0.0
    ) -> float:
