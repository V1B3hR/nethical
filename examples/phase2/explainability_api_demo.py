...
def main():
    ...
    facts = {"region": "EU", "data": {"contains_pii": True, "category": "health"}}
    ...
    decisions = [
        {"decision": "BLOCK", "violations": ["unauthorized_access"], "risk_score": 0.9},
        {"decision": "ALLOW", "violations": [], "risk_score": 0.2},
        {
            "decision": "RESTRICT",
