...
**Generated:** 2026-06-25T05:00:31.768763+00:00
...
## UK NCSC AI SECURE DEV

| ID | Article | Title | Status | Code Modules | Tests | Docs |
|----|---------|-------|--------|--------------|-------|------|
| NCSC-AI-1.1 | Secure Design - 1.1 | AI-Specific Threat Modeling | ✅ | nethical/security/threat_modeling.py | tests/test_phase5_threat_modeling.py | docs/laws_and_policies/threat_model.md |
| NCSC-AI-1.2 | Secure Design - 1.2 | Secure Defaults and validation | ✅ | nethical/core/rbac.py, nethical/security/auth.py... | tests/test_security_hardening.py | docs/security/zero_trust_architecture.md |
| NCSC-AI-2.1 | Secure Development - 2.1 | Supply Chain Security | ✅ | requirements-hashed.txt, SBOM.json | tests/test_regulatory_compliance.py | docs/laws_and_policies/SUPPLY_CHAIN_TODO.md |
| NCSC-AI-2.2 | Secure Development - 2.2 | Technical Documentation and Transparency | ✅ | - | - | docs/compliance/UK_NCSC_AI_SECURE_DEVELOPMENT_COMPLIANCE.md, README.md |
| NCSC-AI-3.1 | Secure Deployment - 3.1 | Model and Data Integrity Protection | ✅ | nethical/security/encryption.py, nethical/security/attestation.py | tests/test_security_hardening.py | docs/security/QUANTUM_CRYPTO_GUIDE.md |
| NCSC-AI-3.2 | Secure Deployment - 3.2 | Security Evaluation and Testing | ✅ | nethical/security/penetration_testing.py | tests/test_phase5_penetration_testing.py | docs/security/red_team_report_template.md |
| NCSC-AI-4.1 | Secure Operation - 4.1 | Continuous Monitoring and Logging | ✅ | nethical/security/anomaly_detection.py, nethical/security/track_analyzer.py | tests/test_phase4_operational_security.py | docs/governance/GOVERNANCE_OBSERVABILITY.md |
| NCSC-AI-4.2 | Secure Operation - 4.2 | Tailored Incident Response | ✅ | nethical/security/soc_integration.py | tests/test_phase4_operational_security.py | docs/compliance/INCIDENT_RESPONSE_POLICY.md |

## Cross-Reference Matrix

This matrix shows which controls satisfy multiple frameworks.

| Category | EU AI Act | UK GDPR | UK DPA 2018 | NHS DSPT | NIST AI RMF | SOC2 | NCSC AI |
|----------|-----------|---------|-------------|----------|-------------|------|---------|
| transparency | 2 | - | 1 | - | 1 | - | - |
| explainability | - | - | - | - | - | - | - |
| human_oversight | 2 | - | - | - | 1 | - | - |
| data_governance | 1 | - | 1 | 2 | - | 1 | 1 |
| risk_management | 4 | 1 | - | - | 5 | - | 1 |
| technical_documentation | 1 | - | - | - | - | - | 1 |
| conformity_assessment | - | - | - | - | - | - | 1 |
| incident_response | - | 1 | - | - | 1 | 1 | 1 |
| audit_logging | 1 | - | - | - | - | - | 1 |
| access_control | - | - | - | 1 | - | 1 | 1 |
| security | 2 | 1 | - | 2 | - | 1 | 1 |
| privacy | - | 4 | - | - | - | - | - |
| fairness | 1 | - | - | - | - | - | - |
