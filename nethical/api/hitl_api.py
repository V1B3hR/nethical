...
from ..core.human_feedback import (
    EscalationQueue,
    FeedbackTag,
    ReviewStatus,
    ReviewPriority
...
class HITLReviewAPI:
    ...
    def get_escalation_queue_endpoint(
        ...
        try:
            ...
            # Get queue items
            queue_items = [case.to_dict() for case in list(self.escalation_queue.pending_cases)[:limit]]
    ...
    def get_reviewer_stats_endpoint(
        self,
        reviewer_id: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            assigned_cases = [
                case for case in self.escalation_queue.cases_by_id.values()
                if case.assigned_to == reviewer_id
            ]
            completed_cases = [
                case for case in assigned_cases
    ...
    def get_training_cases_endpoint(
        ...
        try:
            ...
            return APIResponse(
                success=False,
                error=str(e),
                message="Failed to retrieve training cases"
            ).to_dict()
    ...
    def batch_assign_cases_endpoint(
        ...
        try:
            # Get pending cases
            queue_items = [case.to_dict() for case in list(self.escalation_queue.pending_cases)[:count * 2]]
            ...
            return APIResponse(
                success=False,
                error=str(e),
                message="Failed to assign cases"
            ).to_dict()
