"""Baseline ML Classifier for Nethical.

This module provides a simple baseline classifier for training and evaluation.
It's designed to be compatible with the training pipeline in scripts/train_model.py.
"""
