...
class QuotaEnforcer:
    ...
    def get_usage_summary(self, entity_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "first_request": (
                datetime.fromtimestamp(usage.first_request_time).isoformat()
                if usage.first_request_time
                else None
            ),
            "last_request": (
                datetime.fromtimestamp(usage.last_request_time).isoformat()
                if usage.last_request_time
                else None
            ),
            "last_violation": (
                datetime.fromtimestamp(usage.last_violation_time).isoformat()
