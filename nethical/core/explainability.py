...
class DecisionExplainer:
    ...
    def _generate_natural_language(
        ...
        if contributing_factors:
            ...
            if factor_summaries:
                additional_parts.append("Contributing factors include: " + ", ".join(factor_summaries))
        ...
        additional_details = ". ".join(additional_parts) if additional_parts else "No additional details available"
    ...
    def generate_report(
        ...
        for decision_data in decisions:
            ...
            for violation in violations:
                vtype = violation if isinstance(violation, str) else violation.get('type', 'unknown')
