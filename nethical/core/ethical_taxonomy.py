...
class EthicalTaxonomy:
        ...
        return {
            **stats,
            ...
            'most_common_dimensions': [
                {'dimension': d, 'usage_count': c}
                for d, c in sorted_dimensions[:5]
            ],
    ...
    def get_dimension_report(self, dimension: str) -> Dict[str, Any]:
        ...
        violations_with_dimension = [
            vtype for vtype, scores in self.mapping.items()
        ...
        scores = [
            scores[dimension]
            for scores in self.mapping.values()
            if dimension in scores
        ]
