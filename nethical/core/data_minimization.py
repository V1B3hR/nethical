...
class DataMinimization:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_records": sum(1 for r in self.records.values() if not r.deleted),
            ...
            "retention_policies": {
                cat.value: rule.retention_days for cat, rule in self.policies.items()
            },
        }
    ...
    def validate_compliance(self) -> Dict[str, Any]:
        ...
        """
        validation = {"compliant": True, "checks": {}, "violations": []}
