...
class AttackTreeAnalyzer:
    ...
    def create_attack_tree(
        ...
        root = AttackTreeNode(id=tree_id, name=root_name, description=root_description)
    ...
    def generate_comprehensive_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "threat_intelligence": {
                ...
                "last_update": (
                    self.threat_intelligence.last_update.isoformat()
                    if self.threat_intelligence.last_update
                    else None
                ),
