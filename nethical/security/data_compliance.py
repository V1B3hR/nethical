...
class DataSubjectRequest:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "requested_data_categories": [c.value for c in self.requested_data_categories],
                ...
                with open(stores_file, 'r') as f:
                    ...
                    for store_data in data:
                        store = DataStore(
                            ...
                            data_categories={DataCategory(c) for c in store_data["data_categories"]},
        ...
        data = [
            {
                ...
                "source_region": flow.source_region.value if flow.source_region else None,
...
class DataSubjectRequestHandler:
    ...
    def process_deletion_request(
        ...
        logger.info(
            f"Completed deletion request {request_id} (dry_run={dry_run})"
        )
