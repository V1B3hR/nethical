...
class TestToolHandler:
    ...
    def test_handle_missing_action(self):
        ...
        tool_input = {"agent_id": "test-agent"}
...
class TestEvaluateAction:
    ...
    def test_evaluate_with_action_type(self):
        ...
        decision = evaluate_action("generate code", action_type="code_generation")
...
class TestGovernanceInstance:
    ...
    def test_governance_with_custom_storage(self):
        ...
        instance = get_governance_instance(storage_dir="/tmp/test_nethical_claude")
...
class TestErrorHandling:
    ...
    def test_handle_invalid_input_type(self):
        ...
        tool_input = {"action": ["not", "a", "string"]}  # Wrong type
...
class TestPIIDetection:
    ...
    def test_pii_detection_in_result(self):
        ...
        tool_input = {"action": "Process email: user@example.com", "agent_id": "test"}
...
class TestDecisionTypes:
    ...
    def test_allow_decision_format(self):
        ...
        tool_input = {"action": "print('safe')", "agent_id": "test"}
    ...
    def test_block_decision_format(self):
        ...
        tool_input = {"action": "rm -rf /", "agent_id": "test"}  # Potentially dangerous
