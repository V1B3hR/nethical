...
class TestIntegration:
    ...
    def test_multi_webhook_notification_system(self, mock_dispatch):
        ...
        manager = WebhookManager()
        manager.add_webhook("slack", SlackWebhookDispatcher("https://hooks.slack.com/..."))
        manager.add_webhook("discord", DiscordWebhookDispatcher("https://discord.com/..."))
        manager.add_webhook("custom", HTTPWebhookDispatcher("https://custom.webhook.com"))
    ...
    def test_api_webhook_integration(self):
        ...
        manager = WebhookManager()
        manager.add_webhook("notifications", HTTPWebhookDispatcher("https://notify.com"))
