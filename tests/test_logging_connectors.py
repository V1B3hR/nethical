...
class TestSyslogConnector:
    ...
    def test_connector_creation_udp(self):
        ...
        connector = SyslogConnector(host="localhost", port=514, protocol="UDP")
...
class TestCloudWatchConnector:
    ...
    def test_connector_creation(self):
        ...
        connector = CloudWatchConnector(
            log_group="test-group", log_stream="test-stream", region="us-east-1"
        )
    ...
    def test_batch_send(self):
        ...
        connector = CloudWatchConnector(
            log_group="test-group", log_stream="test-stream", batch_size=3
        )
