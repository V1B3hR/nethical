...
class TestAlertSystem:
    ...
    def test_acknowledge_alert(self):
        ...
        alert = system.create_alert(
            severity=AlertSeverity.WARNING, probe_name="test-probe", message="Test"
        )
    ...
    def test_check_escalation(self):
        ...
        # Create alert
        alert = system.create_alert(
            AlertSeverity.CRITICAL, "test-probe", "Test escalation"
        )
    ...
    def test_escalation_with_acknowledgment(self):
        ...
        alert = system.create_alert(AlertSeverity.CRITICAL, "test-probe", "Test")
    ...
    def test_register_handler(self):
        ...
        system.create_alert(AlertSeverity.CRITICAL, "test-probe", "Critical alert")
