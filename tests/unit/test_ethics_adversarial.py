...
class TestSemanticConceptDetection:
    ...
    async def test_jailbreak_pattern_direct(self):
        ...
        has_jailbreak = any(
            "jailbreak" in v.description.lower()
            or "bypass" in v.description.lower()
            or "ignore" in v.description.lower()
            for v in violations
        )
    ...
    async def test_deception_technique(self):
        ...
        has_deception = any(
            "decep" in v.description.lower()
            or "mislead" in v.description.lower()
            or "misinformation" in v.description.lower()
            for v in violations
        )
...
class TestSemanticConceptThresholds:
    ...
    def test_concept_thresholds_defined(self):
        ...
        if hasattr(detector, "SEMANTIC_CONCEPTS"):
            ...
            for concept in detector.SEMANTIC_CONCEPTS.keys():
                assert (
                    concept in detector.CONCEPT_THRESHOLDS
    ...
    def test_semantic_input_length_limit(self):
        ...
        detector = EthicalViolationDetector(max_semantic_input_length=100)
...
class TestBackwardCompatibility:
    ...
    async def test_normal_text_still_works(self):
        ...
        detector = EthicalViolationDetector(enable_adversarial_detection=True)
    ...
    async def test_adversarial_detection_disabled(self):
        ...
        detector = EthicalViolationDetector(enable_adversarial_detection=False)
    ...
    async def test_semantic_matching_disabled(self):
        ...
        detector = EthicalViolationDetector(
            enable_semantic_matching=False, enable_adversarial_detection=True
        )
...
class TestPerformanceConsiderations:
    ...
    def test_short_text_skips_semantic(self):
        ...
        detector = EthicalViolationDetector(
            enable_semantic_matching=True, enable_adversarial_detection=True
        )
