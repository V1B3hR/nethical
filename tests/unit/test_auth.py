...
class TestAuthManager:
    ...
    def test_verify_expired_token(self):
        ...
        auth = AuthManager(
            secret_key="test-key", access_token_expiry=timedelta(seconds=0)
        )
    ...
    def test_create_api_key(self):
        ...
        key_string, api_key = self.auth.create_api_key(
            user_id="user123", name="Test API Key"
        )
    ...
    def test_api_key_with_expiry(self):
        ...
        key_string, api_key = self.auth.create_api_key(
            user_id="user123", name="Temporary Key", expires_at=expires_at
        )
    ...
    def test_token_scope(self):
        ...
        token, payload = self.auth.create_access_token(
            "user123", scope="read:data write:data"
        )
...
class TestAuthIntegration:
    ...
    def test_api_key_workflow(self):
        ...
        # 1. Create API key
        key_string, api_key = self.auth.create_api_key(
            user_id="service_account", name="Service API Key"
        )
