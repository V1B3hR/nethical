...
class TestSemanticSimilarity:
    ...
    def test_paraphrase_similarity(self):
        ...
        if is_semantic_available():
            ...
            assert semantic_sim > 0.5, "Paraphrases should have moderate-high similarity"
        else:
...
@pytest.mark.parametrize("intent,action,expected_high_semantic", [
...
@pytest.mark.parametrize("intent,action,expected_deviation", [
