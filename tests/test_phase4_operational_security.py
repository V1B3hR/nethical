...
class TestSecretScanner:
    ...
    def test_scan_text_api_key(self):
        ...
        api_key_findings = [
            f for f in findings if f.get("secret_type") == SecretType.API_KEY.value
        ]
    ...
    def test_scan_text_password(self):
        ...
        pwd_findings = [
            f for f in findings if f.get("secret_type") == SecretType.PASSWORD.value
        ]
...
class TestPhase4Integration:
    ...
    def test_integrated_operational_security(self):
        ...
        allowed, _ = zt_controller.authorize_access(
            token, "secure-api", "api", "device-1"
        )
