...
class TestThreatIntelligenceFeed:
    ...
    def test_get_indicators_by_type(self):
        ...
        feed.add_indicator("ip", "192.168.1.1", ThreatSeverity.HIGH, "Malicious IP", "source1")
        feed.add_indicator("domain", "evil.com", ThreatSeverity.CRITICAL, "Malicious domain", "source2")
        feed.add_indicator("ip", "192.168.1.2", ThreatSeverity.MEDIUM, "Suspicious IP", "source1")
    ...
    def test_check_indicator(self):
        ...
        feed.add_indicator("ip", "192.168.1.100", ThreatSeverity.HIGH, "Known bad IP", "source")
...
class TestAttackTreeAnalyzer:
    ...
    def test_calculate_tree_risk_or_gate(self):
        ...
        analyzer.add_child_node(root, "C1", "Method 1", "First method", 
                               probability=0.3, impact=0.8)
        analyzer.add_child_node(root, "C2", "Method 2", "Second method",
    ...
    def test_calculate_tree_risk_and_gate(self):
        ...
        analyzer.add_child_node(root, "C1", "Step 1", "First step",
                               probability=0.8, impact=0.7)
        analyzer.add_child_node(root, "C2", "Step 2", "Second step",
...
class TestSecurityRequirementsTraceability:
    ...
    def test_link_to_test(self):
        ...
        assert "test_authentication.py::test_login" in matrix.requirements["REQ001"].test_cases
