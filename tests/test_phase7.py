...
class TestSequenceAnomalyDetector:
    ...
    def test_initialization(self):
        ...
        detector = SequenceAnomalyDetector(n=3, min_frequency=2, anomaly_threshold=0.8)
...
class TestDistributionDriftDetector:
    ...
    def test_initialization(self):
        ...
        detector = DistributionDriftDetector(
            num_bins=10, psi_threshold=0.2, kl_threshold=0.1
        )
    ...
    def test_detect_drift_with_drift(self):
        ...
        detector = DistributionDriftDetector(psi_threshold=0.1, kl_threshold=0.05)
...
class TestAnomalyDriftMonitor:
    ...
    def test_initialization(self):
        ...
        monitor = AnomalyDriftMonitor(sequence_n=3, psi_threshold=0.2, kl_threshold=0.1)
