...
def test_train_with_audit_logging():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert all(c in '0123456789abcdef' for c in merkle_root), "Invalid Merkle root format"
        ...
        assert chunk_data['event_count'] == len(chunk_data['events']), "Event count mismatch"
