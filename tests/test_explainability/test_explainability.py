...
class TestDecisionExplainer:
    ...
    def test_explain_block_decision(self):
        ...
        risk_scores = {"security": 0.8, "privacy": 0.6}
...
class TestNaturalLanguageGenerator:
    ...
    def test_markdown_conversion(self):
        ...
        explanation = generator.generate_explanation(
            decision="ALLOW", context={}, components=[], reasoning_chain=[]
        )
    ...
    def test_html_conversion(self):
        ...
        explanation = generator.generate_explanation(
            decision="RESTRICT", context={}, components=[], reasoning_chain=[]
        )
...
class TestTransparencyReportGenerator:
    ...
    def test_generate_report(self):
        ...
        violations = [
            {"type": "security", "severity": "high", "timestamp": now.isoformat()}
        ]

        policies = [{"name": "policy1"}, {"name": "policy2"}]

        report = generator.generate_report(
            decisions=decisions, violations=violations, policies=policies, period_days=7
        )
    ...
    def test_json_export(self):
        ...
        report = generator.generate_report(
            decisions=[], violations=[], policies=[], period_days=7
        )
